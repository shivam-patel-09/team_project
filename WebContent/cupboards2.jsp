<%@include file="otherHeader.jsp"%>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/cupboard2.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Hilton Engineered Wood 4 Door Wardrobe With Mirror In Spiced Acacia Finish</h2>
                        <div class="product_details_price">Price: $2669</div>
                        ...
                        <a href="#" class="btn btn-success my-2">ADD TO CART</a>
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <ul>
                            <li><b>Availability</b> <span>In Stock</span></li>
                            <li><b>color</b> <span>As shown in image </span></li>
                            <li><b>Dimensions</b> <span>202.0 cm x 158.0 cm x 53.0 cm</span></li>
                            <li><b>Room Type:</b>
                                <span> BedRoom</span>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product_detailstab_desc ">
                                   ...
                                   <ul>
                                   	...
                                   	<li>From the wizarding world of wardrobes. The Hilton is no ordinary wardrobe. With an uncanny ability to match your storage needs, there's magic about it. Drawers, hangers and shelves of various sizes make room for your essentials. The elegant finish and neat handles add aesthetics to function. Need a quick vanity check? Opt for the mirrored variants, and step out looking your best!</li>
