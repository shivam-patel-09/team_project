<%@include file="otherHeader.jsp"%>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/desk88.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Caribu 4 To 6 Extendable - Doris (Leatherette) 4 Seater Dining Table Set</h2>
                        <div class="product_details_price">Price: $2524</div>
