<%@include file="otherHeader.jsp"%>
                    ...
                    <div class="breadcrumb__text">
                     <h2 class="mt-3">Fabric Sofa</h2> 
                      <div class="breadcrumb__option">
                            ...
                            <span>2 seater Fabric Sofa</span>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/fabric2.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Izmir Decadence Fabric Sofa (Blue)</h2>
                        <div class="product_details_price">Price: $4230</div>
                        ...
                        <ul>
                            ...
                            <li><b>Dimensions</b> <span>86.0 cm x 86.0 cm x 147.0 cm</span></li>
                            <li><b>Room Type:</b>
                                <span>Living/Bed Room</span>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="tab-content" style="padding: 15px;  font-size: 15px; ">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product_detailstab_desc ">
                                   ...
                                   <ul>
                                   	<li>A Class Apart In Design, Durability and Comfort, This Stylish-Seater Sofa From Urban Living Provides A Comfortable Seating Area For Your Living Room.</li>
                                   	<li>Its Elegant Design Also Adds To The Decor of Your House</li>
