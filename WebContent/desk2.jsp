<%@include file="otherHeader.jsp"%>
                      ...
                      <div class="breadcrumb__option">
                            <a href="./index.jsp">Home></a>
                             <a href="./furniture.jsp">Trending Furniture></a>
                              ...
                              <a href="./chair_desk.jsp">Desk Chairs></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/desk77.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Lawson Solid Wood 4 Seater Dining Table With Set Of Chairs In Walnut Finish</h2>
                        <div class="product_details_price">Price: $3334</div>
