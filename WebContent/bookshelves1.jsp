...
function Feedback(){
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/bookshelve1.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                    		<input type="hidden" id="productImage" value="bookshelve1.jpg">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Iwaki Bookshelf/Display Cabinet With Glass Door</h2>
                        <div class="product_details_price">Price: $2470</div>
                        <input type="hidden" id="productAmount" value="2470">
                        ...
                        <ul>
                            ...
                            <li><b>Dimensions</b> <span>180.0 cm x 150.0 cm x 29.0 cm </span></li>
                            <li><b>Room Type:</b>
                            ...
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product_detailstab_desc ">
                                   ...
                                   <ul>
                                   	...
                                   	<li>Look well read. Show off your Tolstoys, Hemingways, and other serious reads with the Iwaki bookshelf. The glass-front panels are perfect to make a good impression. For guilty pleasures like your Fifty Shades series, we've also added drawers below. After all, we don't need someone's judgy stares ruining a good read</li>
                                   	<li>Made from MDF and glass</li>
