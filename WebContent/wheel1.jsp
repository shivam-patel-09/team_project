<%@include file="otherHeader.jsp"%>
                      ...
                      <div class="breadcrumb__option">
                            <a href="./index.jsp">Home></a>
                             <a href="./furniture.jsp">Trending Furniture></a>
                              ...
                              <a href="./chair_wheel.jsp">Wheel Chairs></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/wheel11.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Jean Plastic Study Chair In Brown Leatherette Colour</h2>
                        <div class="product_details_price">Price: $1014</div>
