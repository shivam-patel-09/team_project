...
function Feedback(){
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                     <h2 class="mt-3">Diwans</h2> 
                      <div class="breadcrumb__option">
                            <a href="./index.jsp">Home></a>
                             <a href="./furniture.jsp">Trending Furniture></a>
                              <a href="./sofa.jsp"> Sofas></a>
                              <a href="./product_diwans.jsp">Diwans></a>
                              
                            <span>Diwans sofa set </span>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/diwans1.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                    		<input type="hidden" id="productImage" value="diwans1.jpg">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Milton Diwan In Blue Colour</h2>
                        <div class="product_details_price">Price: $3014</div>
                        <input type="hidden" id="productAmount" value="3014">
                        ...
                        <ul>
                            ...
                            <li><b>Dimensions</b> <span>70.0 cm x 180.0 cm x 79.0 cm </span></li>
                            <li><b>Room Type:</b>
                            ...
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product_detailstab_desc ">
                                   ...
                                   <ul>
                                   	...
                                   	<li>Beauty on double duty. The Milton Day Bed is a sleek divan that doubles up as a comfortable spot for a mid-afternoon nap. Squared edges are balanced out by rounded bolsters, making it the perfect addition to a family living room or guest bedroom.</li>
                                   	<li>Frame and base made of Sheesham wood</li>
                                   	<li>Comes with bolsters</li>
