...
function Feedback(){
    ...
    <form id="addToCartId" action="addToCart" method="post">
   		...
   		<input type="hidden" name="pname" value="Stool chair">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                     <h2 class="mt-3">Fancy Chairs</h2> 
                      <div class="breadcrumb__option">
                            <a href="./index.jsp">Home></a>
                             <a href="./furniture.jsp">Trending Furniture></a>
                              <a href="./chair1.jsp"> Chair></a>
                              <a href="./chair_fancy.jsp">Fancy Chairs></a>
                              
                            <span> Stool chair</span>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/fancy11.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                    		<input type="hidden" id="productImage" value="fancy11.jpg">
    ...
    color: #2F4858;; font-size: 30px;">Pashe Plain Fabric Accent Chair In Teal Colour</h2>
   <input type="hidden" id="productName" value="Pashe Plain Fabric Accent Chair In Teal Colour">
                        <div class="product_details_price">Price: $2024</div>
                        <input type="hidden" id="productAmount" value="2024">
