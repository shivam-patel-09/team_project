<%@include file="otherHeader.jsp"%>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/fancy55.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Loria Solid Wood Study Chair In Brown Colour</h2>
                        <div class="product_details_price">Price: $133</div>
