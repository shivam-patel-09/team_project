<%@include file="otherHeader.jsp"%>
                      ...
                      <div class="breadcrumb__option">
                            <a href="./index.jsp">Home></a>
                             <a href="./furniture.jsp">Trending Furniture></a>
                              ...
                              <a href="./chair_folding.jsp">Folding Chairs></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/folding33.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Masai Solid Wood Bench In Dark Teak Finish</h2>
                        <div class="product_details_price">Price: $814</div>
