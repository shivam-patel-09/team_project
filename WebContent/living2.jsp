<%@include file="otherHeader.jsp"%>
    ...
    color: #2F4858;; font-size: 30px;">Zenga Solid Wood Side Table In Antique Walnut Finish</h2>
                        <div class="product_details_price">Price: $1338</div>
                        ...
                        <ul>
                            ...
                            <li><b>Dimensions</b> <span>62.0 cm x 71.0 cm x 35.0 cm </span></li>
                            <li><b>Room Type:</b>
                                <span>Living</span>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" style="padding: 15px;  font-size: 15px; ">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product_detailstab_desc ">
                                   ...
                                   <ul>
                                   	<li>The cool side table. If you thought side tables are just another piece of storage, think again. This piece of wonder is the perfect blend of antique carvings on modern design. It marks its own space and demands attention with its effortless sass. The beautifully hand carved patterns compliment the unconventional design, making it a must have versatile piece. 
                                   	</li>
                                   	<li>Made from Mango wood</li>
                                   	<li>Crafted in solid wood and MDF with an antique finish</li>
                                   	<li>Carefully handcrafted design</li>
