<%@include file="otherHeader.jsp"%>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                     <h2 class="mt-3">L Shape</h2> 
                      <div class="breadcrumb__option">
                            <a href="./index.jsp">Home></a>
                             <a href="./furniture.jsp">Trending Furniture></a>
                              <a href="./sofa.jsp"> Sofas></a>
                              <a href="./product_lshape.jsp">L Shape></a>
                              
                            <span>L Shape sofa set </span>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product_details_pic">
                        <div class="img-box">
                    		<img src="images/Lshape2.jpg" style="width: 100%; height:100%; margin-left: 0%;" alt="">
                        </div>
    ...
    color: #2F4858;; font-size: 30px;">Suwon U Shape Leatherette Sofa - Brown & Beige</h2>
                        <div class="product_details_price">Price: $10934</div>
                        ...
                        <ul>
                            ...
                            <li><b>Dimensions</b> <span>91.0 cm x 176.0 cm x 101.0 cm </span></li>
                            <li><b>Room Type:</b>
                            ...
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product_detailstab_desc ">
                                   ...
                                   <ul>
                                   	...
                                   	<li>None Standard Set - Sofas, Leatherette Sofa Material, Regular Sofa Size, Soft Cushion Type, Regular Sofa Type, U Shaped Sofa Custom Set - Sofas, brown & beige</li>
